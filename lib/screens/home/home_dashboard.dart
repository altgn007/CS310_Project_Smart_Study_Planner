  ...
  Widget _buildBottomNav(BuildContext context, int currentIndex) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _navItem(icon: Icons.home_rounded, label: 'Home', active: currentIndex == 0, onTap: () {}),
          _navItem(icon: Icons.calendar_today_outlined, label: 'Schedule', active: currentIndex == 1, onTap: () {}),
          _navItem(icon: Icons.chat_bubble_outline, label: 'Coach', active: currentIndex == 2, onTap: () {}),
          _navItem(icon: Icons.person_outline, label: 'Profile', active: currentIndex == 3, onTap: () {}),
        ],
      ),
    );
  }
